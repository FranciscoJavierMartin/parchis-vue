import { EXIT_TILES_VALUES, FINAL_POSITIONS_VALUES, POINTS } from '@/constants/positions-board';
import { SIZE_TILE } from '@/constants/sizes';
import type { IPoint, IPositionsItems, TLocationBoardElements } from '@/interfaces/board';
